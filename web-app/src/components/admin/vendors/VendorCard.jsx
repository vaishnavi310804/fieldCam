...
const VendorCard = ({ vendor }) => {
  const isPositiveChange = vendor.monthlyChange.startsWith("+");
      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#817B77] mt-0.5">{vendor.contact}</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between my-2 text-xs">
          <div className="flex items-center gap-1">
            ...
            <span className="font-bold text-[#3E3734]">{vendor.rating}</span>
          </div>
          ...
          >
            ...
            <span>{vendor.monthlyChange} this month</span>
          </div>
        </div>
